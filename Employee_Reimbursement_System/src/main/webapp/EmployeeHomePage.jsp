...
<h3><i>Employment for a better nation.</i></h3>
<div class="center">
<form action="http://localhost:8081/Employee_Reimbursement_System/3Application.jsp"  method="post">
<div class="row">
       <div class="col-25">
...
<div class="center">
<form action="http://localhost:8081/Employee_Reimbursement_System/Reimdetailsforemp"  method="post">
<div class="row">
      <div class="col-25">
...
<div class="center">
<form action="http://localhost:8081/Employee_Reimbursement_System/Detailsofemp"  method="post">
<div class="row">
      <div class="col-25">
...
<div class="center">
<form action="http://localhost:8081/Employee_Reimbursement_System/UpdateEmployee.jsp"  method="post">
<div class="row">
      <div class="col-25">
