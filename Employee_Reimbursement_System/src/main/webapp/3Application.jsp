...
<form  action="http://localhost:8081/Employee_Reimbursement_System/EmployeeHomePage.jsp" method="post">
<P><b>If you are already applied, go to home page </b>
...
<div class="container">
  <form action="http://localhost:8081/Employee_Reimbursement_System/ApplicationServlet" method="post">
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <select id="type" name="type">
          ...
          <option value="Healthcare Reimbursements">Health care Reimbursements</option>
